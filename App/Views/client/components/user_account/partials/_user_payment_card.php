            ...
            <div class="row">
               <div class="col-md-4 col-sm-6 credit-card">
                  <div class="single-card-info d-flex">
                     <div class="card-icon">
                        <img src="https://localhost:8001/public/assets/img/account_visa.png" alt="Card">
                     </div>
               ...
               <div class="col-md-4 col-sm-6 credit-card">
                  <div class="single-card-info d-flex">
                     <div class="card-icon">
                        <img src="https://localhost:8001/public/assets/img/account_american-express.png" alt="Card">
                     </div>
                     <div class="card-info media-body">
                        <h5 class="card-name">Musa Ahmed</h5>
                        <p class="card-number">.... 4534 <span>02/20</span></p>
               ...
               <div class="col-md-4 col-sm-6 credit-card">
                  <div class="single-card-info d-flex">
                     <div class="card-icon">
                        <img src="https://localhost:8001/public/assets/img/account_mastercard.png" alt="Card">
                     </div>
                     <div class="card-info media-body">
                        <h5 class="card-name">Musa Ahmed</h5>
                        <p class="card-number">.... 4534 <span>02/20</span></p>
