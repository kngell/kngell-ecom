<div class="row transaction-menu">
      ...
      <div class="card h-100" id="orders">
         <div class="card-body">
            <h5 class="card-title"><span class="card-img-wrapper"><img
                     src="https://localhost:8001/public/assets/img/account_mescommandes.png" alt="Mes commandes"
   ...
   <div class="col-sm-6 transaction-item">
      <div class="card h-100">
         <div class="card-body">
            <h5 class="card-title"><span class="card-img-wrapper"><img
                     src="https://localhost:8001/public/assets/img/account_donnees-personnelles.png"
   ...
   <div class="col-sm-6 transaction-item">
      <div class="card h-100" id="address_book">
         <div class="card-body">
            <h5 class="card-title"><span class="card-img-wrapper"><img
                     src="https://localhost:8001/public/assets/img/account_adresses.png" alt="Mes adresses"
                     class="img-fluid"></span>Mes
               addresses</h5>
   ...
   <div class="col-sm-6 transaction-item">
      <div class="card h-100">
         <div class="card-body">
            <h5 class="card-title"><span class="card-img-wrapper"><img
                     src="https://localhost:8001/public/assets/img/account_mode-de-paiement.png"
