...
<main id="main-site">
    ...
    <div class="k-container k-mt-5">
        <div class="k-row k-justify-center">
            ...
            <div class="k-col-xs-12 k-col-md-5"><img src="https://localhost:8001/public/assets/img/accessories-collection.png" alt="">
            </div>
        </div>
    </div>
    <!-- About sSection -->
            ...
            <div class="k-row k-gap-2">
                <div class="k-col-xs-12 k-col-md-6 k-col-lg-3">
                    <div class="k-card k-p-0">
                        ...
                        <img src="https://localhost:8001/public/assets/img/dark-logo.png" alt="">
                ...
                <div class="k-col-xs-12 k-col-md-6 k-col-lg-3">
                    <div class="k-card k-p-0">
                        ...
                        <img src="https://localhost:8001/public/assets/img/header.png" alt="">
                        <p class="k-mt-1">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
                <div class="k-col-xs-12 k-col-md-6 k-col-lg-3">
