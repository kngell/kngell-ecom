...
abstract class AbstractCheckout
{
    ...
    public function __construct(CollectionInterface $userCart, CollectionInterface $shippingClass, CollectionInterface $pmtMode, CheckoutForm $frm, CollectionInterface $paths)
    {
